<template>
	<div
		class="modal d-flex align-items-center position-relative"
		:class="{
			modal__collapsed: !isVisible,
		}"
	>
...
.modal {
	...
	//добавила класс на флаг isVisible, класс и стили меняется в зависимости от стостояния флага
	&__collapsed {
		width: 37%;
	}
}
